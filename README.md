...
- **Presupuesto (`/budget`):** formulario para registrar múltiples ingresos (nombre + monto) y ver el total del mes; los buckets 50/30/20 se calculan automáticamente. Incluye alta de categorías (con monto ideal mensual) y reglas, además de la vista agrupada por Necesarios/Prescindibles/Ahorro.
